...
window.Rainbow = function () {
    ...
    function E(a, b) {
        function c(a, b, h, e) {
            if (h < b.length) {
                ++y;
                var g = b[h], l = j[d][g], a = a.substr(0, g) + a.substr(g).replace(l.replace, l["with"]),
                    g = function () {
                        c(a, b, ++h, e)
                    };
    ...
    function B(a, b) {
        var a = a && "function" == typeof a.getElementsByTagName ? a : document, c = a.getElementsByTagName("pre"),
            d = a.getElementsByTagName("code"), f, e = [];
